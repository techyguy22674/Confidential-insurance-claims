...
export type Witnesses<PS> = {
  policyholderSecretKey?(ctx: __compactRuntime.WitnessContext<Ledger, PS>): [PS, Uint8Array];
  claimProofNonce?(ctx: __compactRuntime.WitnessContext<Ledger, PS>): [PS, Uint8Array];
  incidentReportHash?(ctx: __compactRuntime.WitnessContext<Ledger, PS>): [PS, Uint8Array];
  coverageDaysRemaining?(ctx: __compactRuntime.WitnessContext<Ledger, PS>): [PS, bigint];
  insurerSigningKey?(ctx: __compactRuntime.WitnessContext<Ledger, PS>): [PS, Uint8Array];
...
export type ImpureCircuits<PS> = {
  fileInsuranceClaim(ctx: __compactRuntime.CircuitContext<PS>, expectedPolicyId_0: Uint8Array): __compactRuntime.CircuitResults<PS, Uint8Array>;
  verifyClaim(ctx: __compactRuntime.CircuitContext<PS>, claimedCommitment_0: Uint8Array): __compactRuntime.CircuitResults<PS, boolean>;
  revokeClaim(ctx: __compactRuntime.CircuitContext<PS>, commitmentToRevoke_0: Uint8Array): __compactRuntime.CircuitResults<PS, Uint8Array>;
  setInsurerCommitment(ctx: __compactRuntime.CircuitContext<PS>, newMinimumDays_0: bigint): __compactRuntime.CircuitResults<PS, Uint8Array>;
  resetPolicy(ctx: __compactRuntime.CircuitContext<PS>, newPolicyId_0: Uint8Array, newMinimumDays_0: bigint): __compactRuntime.CircuitResults<PS, Uint8Array>;
