  ...
  return (
    <header className="nav">
      <Link href="/" className="nav-brand">
        <span>🛡️</span> CIC — Confidential Insurance Claims
      </Link>
      <div className="nav-links">
        <Link href="/" className={"nav-link " + (pathname === "/" ? "active" : "")}>Dashboard</Link>
        <Link href="/claim" className={"nav-link " + (pathname === "/claim" ? "active" : "")}>File & Verify Claim</Link>
        <Link href="/admin" className={"nav-link " + (pathname === "/admin" ? "active" : "")}>Insurer Console</Link>
